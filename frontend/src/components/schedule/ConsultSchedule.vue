...
const editSchedule = (id) => router.push(`/editSchedule/${id}`)

const scheduleDelete = (id) => {
  const urlData = `https://cinema-production-cb13.up.railway.app/api/v1/schedule/${id}`;
  fetch(urlData, {
    method: "DELETE",
  })
        ...
        <div class="card-header">
          <h3 class="card-header-title font-size-lg text-capitalize text-secondary">Horarios</h3>
            ...
            <div style="position: static;">
              <div>
                <ul class=" list-group">
                  <li class="list-group-item" v-for="item in schedules" :key="item.id">
                    ...
                    <div class="widget-content p-0">
                      <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-right">
                          ...
                          <button @click="scheduleDelete(item.id)" class="border-0 btn btn-outline-danger">
