...
const RegistrationSchedule = async () => {
  const formData = new FormData();
  formData.append("start_time", formTime.value.start_time);
  
 console.log(formData)
  const urlDB = `https://cinema-production-cb13.up.railway.app/api/v1/schedule`;
  await fetch(urlDB, {
    method: "POST",
    body: formData,
  })
	...
	<div class="row d-flex justify-content-center container-main">
		<div class="col-12 col-md-8 col-lg-6 col-xl-5">
			<div class="container-form py-3 px-2">
				<h2 class="text-center mb-3 mt-2 h2 text-white">Registrar Horario</h2>
				<div class="division">
					<hr class="line">
				</div>
				<form class="form">
					<div class="form-group">
  					...
  					<div class="form-group buttons mt-3">
						...
						<RouterLink to="/consultSchedule" class="btn btn-block btn-primary btn-lg" href="#">
